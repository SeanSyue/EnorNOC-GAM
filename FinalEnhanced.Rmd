...
eval_table <- data.table(MODELS=c("gam_new_1 ", "gam_new_2", "gam_new_3", "gam_new_4", "gam_new_5", "gam_new_6", "gam_new_simple", "gam_new_te_daily", "gam_new_te_weekly"), eval_table)
eval_table
```
